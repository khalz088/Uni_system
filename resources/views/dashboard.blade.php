                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-5">
                       ...
                       <div>
                        ...
                        @if(\App\Models\Timetable::where('ntalevel_id',auth()->user()->ntalevel_id)->where('course_id', auth()->user()->course_id)->count() > 0)

                            @php
                               $tbale = \App\Models\Timetable::where('ntalevel_id',auth()->user()->ntalevel_id)->where('course_id', auth()->user()->course_id)->first();
                            @endphp
                            <a href="{{'/storage/' . $tbale->path}}" class="p-4 hover:border-2 hover:animate-shake hover:shadow-lg w-36 rounded ">
                                <div>
                                    <div class="justify-center flex">
                                        <div>
